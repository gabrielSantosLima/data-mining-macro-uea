...
chamadas_path = r'C:\Users\SAMSUNG\Documents\GitHub\data-mining-macro-uea\data\pdf\chamadas\2023'
years = [2023]
header = ['nome', 'id_curso_aprovado', 'ano']
dataset(chamadas_path, '2023_approved_candidates.csv', header, years, chamadas_info)
